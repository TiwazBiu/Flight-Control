...
void Control()
{
  ...
  PID_POS_XOUT  = 0.045*( tot_x_cm + 0.00714 * pos_x_i + 35* (tot_x_cm - last_tot_x_cm));//ԭPID_POS_XOUT  = 0.045*( tot_x_cm + 0.00714 * pos_x_i + 35* (tot_x_cm - last_tot_x_cm));
  ...
  PID_POS_YOUT  = 0.045*( tot_y_cm + 0.0035 * pos_y_i + 45* (tot_y_cm - last_tot_y_cm));//ԭPID_POS_YOUT  = 0.045*( tot_y_cm + 0.0035 * pos_y_i + 37.6* (tot_y_cm - last_tot_y_cm));
  //PID_POS_YOUT  = (eeprom_readdate[6]/1000.0) * (tot_y_cm + (eeprom_readdate[7]/100000.0) * pos_y_i + (eeprom_readdate[8]/100.0) * (tot_y_cm - last_tot_y_cm));
