...
//      }
//    }   
    switch(pianliang_count){
    case 0:
      if(Res==0x73){
        pianliang_count=1;
        UART1SendString("0x73 ");}
      else
        pianliang_count=0;
      break;
    case 1:
    ...
    case 2:
      ...
      UART_PIDadjust.fix_pitch=Res;
      pianliang_count=3;
      UART1SendString("fix_buffer1");
    ...
    case 3:
      ...
      break;
    case 4:
      UART_PIDadjust.fix_roll=Res;
      pianliang_count=5;
      UART1SendString("fix_buffer2");
      break;
    case 5:
      if(Res==0x3f){
        //UART_PIDadjust.fix_pitch=fix_buffer[0];
        //UART_PIDadjust.fix_roll=fix_buffer[1];
        UART1SendString("fixchanged"); 
        write_fix();
        UART1SendString("eepromchanged"); 
      }
