...
//  Nrf_Buf_Out.Data_int[2]=(int16)(Ymm_Send);
  Nrf_Buf_Out.Data_int[0]=(int16)deltaX_out;
  Nrf_Buf_Out.Data_int[1]=(int16)deltaY_out;
  Nrf_Buf_Out.Data_int[2]=(int16)imgresult.state;
  Nrf_Buf_Out.Data_int[3]=(int16)ks103_distance/10;
  //Nrf_Buf_Out.Data_int[3]=(int16)RENESAS.UART1FLAG;
